...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('➕↖️ Add Me To Your channel ↗️➕', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
            ],[
            InlineKeyboardButton('⚡ Movie channel ⚡', url=f"https://t.me/addlist/EM1P-cafbNU4MWE1"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/addlist/EM1P-cafbNU4MWE1')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [InlineKeyboardButton('➕↖️ Add Me To Your channel ↗️➕', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
            ],[
            InlineKeyboardButton('⚡ Movie channel ⚡', url=f"https://t.me/addlist/EM1P-cafbNU4MWE1"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/addlist/EM1P-cafbNU4MWE1')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/moviesimplyfytuber')],InlineKeyboardButton('More Channels ', url='https://t.me/addlist/EM1P-cafbNU4MWE1') ] ),
        protect_content=True if pre == 'filep' else False,
        )
